...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.vvvirani.flutter_audio_trimmer.FlutterAudioTrimmerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_audio_trimmer, com.vvvirani.flutter_audio_trimmer.FlutterAudioTrimmerPlugin", e);
    }
    try {
